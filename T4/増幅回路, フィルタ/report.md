...
シミュレーションの結果のボーデ線図を図 6 に示す。

利得が平坦な区間は約 1.97 [Hz] ~ 1.21 [MHz] であり、その範囲での利得は約 47.7 [dB] であった。
また、47.7 [dB] から -3 [dB] のカットオフ周波数は、低域カットオフ周波数が 0.68 [Hz]、高域カットオフ周波数が 3.5 [MHz] であった。よって、帯域幅は約 3.5 [MHz] であった。
